...
[source,sh]
----
docker images kieranpotts/devenv:latest
----
...
[source,sh]
----
docker run -it --rm kieranpotts/devenv:latest bash
----
...
Images are hosted on https://hub.docker.com/r/kieranpotts/devenv[Docker Hub].
...
* Apply a versioned tag, eg. `kieranpotts/devenv:1.0.0`, based on the current Git tag.
...
[source,sh]
----
docker pull kieranpotts/devenv:latest
docker pull kieranpotts/devenv:1.0.0
----
